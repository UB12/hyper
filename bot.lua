...
local BASE_URL = "https://api.telegram.org/bot310006574:AAEMWedI8VPApPkRyFRqEBuWj4O1g2tryd4"..bot_api_key
local BASE_FOLDER = ""
local start = [[
...
function is_admin(msg)-- Check if user is admin or not
  local var = false
  local admins = {311680976}-- ایدی خودتون رو قرار بدید --
